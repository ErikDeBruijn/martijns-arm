// ============================================================
//  Robotarm Teach & Repeat  –  v16  (3 motoren, 3.5:1 tandriem)
//
...
static const uint8_t TCA_CHANNELS[3]     = {0, 3, 7};  // M1=ch0, M2=ch3, M3=ch7

// Arm-as encoders — v16: aangepast voor nieuw hardware ontwerp
static const uint8_t TCA_ARM_CHANNELS[3] = {1, 2, 6};  // M1=ch1, M2=ch2, M3=ch6
